        ...
        button: [
            {
                ...
                callback: function () {
                    ...
                    var type = "edit";
                    window.location.href = "/SellerAdmin/TechInfo/EditUploadfile?parentId=" + parentId + '&attachmentName=' + attachmentName + '&type=' + type;
                }
            },
            {
                name: '取消',
        ...
        button: [
            {
                ...
                callback: function () {
                    ...
                    var attachmentName = $("#techTitle").val();
                    var type = "add";
                    window.location.href = "/SellerAdmin/TechInfo/Uploadfile?parentId=" + parentId + '&attachmentName=' + attachmentName + '&type=' + type;
                }
            },
            {
                name: '取消',
