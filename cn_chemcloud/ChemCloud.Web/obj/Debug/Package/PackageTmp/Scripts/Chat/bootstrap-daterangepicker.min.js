    ...
    s.prototype = {
        constructor: s, setOptions: function (t, e) {
            ...
            if (void 0 === t.startDate && void 0 === t.endDate && i(this.element).is("input[type=text]")) {
                ...
                var d = this.container.find(".calendar.first"), m = this.container.find(".calendar.second")
                m.hasClass("single") && (m.removeClass("single"), d.addClass("single")), d.removeClass("left").addClass("right"), m.removeClass("right").addClass("left"), this.singleDatePicker && (d.show(), m.hide())
            } void 0 !== t.ranges || this.singleDatePicker || this.container.addClass("show-calendar"), this.container.addClass("opens" + this.opens), this.updateView(), this.updateCalendars()
        ...
        }, showCalendars: function () { this.container.addClass("show-calendar"), this.move(), this.element.trigger("showCalendar.daterangepicker", this) }, hideCalendars: function () { this.container.removeClass("show-calendar"), this.element.trigger("hideCalendar.daterangepicker", this) }, inputsChanged: function (t) {
            ...
            if (this.chosenLabel = this.locale.customRangeLabel, t.isAfter(e)) {
                ...
                e = a(t).add(i, "ms"), this.maxDate && e.isAfter(this.maxDate) && (e = this.maxDate)
            ...
            var o, h = a([e, t]).daysInMonth(), l = a([e, t, 1]), c = a([e, t, h]), d = a(l).subtract(1, "month").month(), m = a(l).subtract(1, "month").year(), f = a([m, d]).daysInMonth(), p = l.day(), u = []
            for (u.firstDay = l, u.lastDay = c, o = 0; 6 > o; o++) u[o] = []
            var D = f - p + this.locale.firstDay + 1
            D > f && (D -= 7), p == this.locale.firstDay && (D = f - 6)
            var g, y, k = a([m, d, D, 12, s, n]).zone(this.timeZone)
            ...
            o += "</select>"
            for (var d = '<select class="yearselect">', m = r; n >= m; m++) d += '<option value="' + m + '"' + (m === s ? ' selected="selected"' : "") + ">" + m + "</option>"
            return d += "</select>", o + d
            ...
            if (this.timePicker) {
                ...
                var f = 0, p = 23
                a && ("left" == n || this.singleDatePicker) && e.format("YYYY-MM-DD") == a.format("YYYY-MM-DD") && (f = a.hour(), e.hour() < f && e.hour(f), this.timePicker12Hour && f >= 12 && e.hour() >= 12 && (f -= 12), this.timePicker12Hour && 12 == f && (f = 1)), s && ("right" == n || this.singleDatePicker) && e.format("YYYY-MM-DD") == s.format("YYYY-MM-DD") && (p = s.hour(), e.hour() > p && e.hour(p), this.timePicker12Hour && p >= 12 && e.hour() >= 12 && (p -= 12))
                var u = 0, D = 23, g = e.hour()
                for (this.timePicker12Hour && (u = 1, D = 12, g >= 12 && (g -= 12), 0 === g && (g = 12)), m = u; D >= m; m++) r += m == g ? '<option value="' + m + '" selected="selected">' + m + "</option>" : f > m || m > p ? '<option value="' + m + '" disabled="disabled" class="disabled">' + m + "</option>" : '<option value="' + m + '">' + m + "</option>"
                r += "</select> : ", r += '<select class="minuteselect">'
                var y = 0, k = 59
                for (a && ("left" == n || this.singleDatePicker) && e.format("YYYY-MM-DD h A") == a.format("YYYY-MM-DD h A") && (y = a.minute(), e.minute() < y && e.minute(y)), s && ("right" == n || this.singleDatePicker) && e.format("YYYY-MM-DD h A") == s.format("YYYY-MM-DD h A") && (k = s.minute(), e.minute() > k && e.minute(k)), m = 0; 60 > m; m += this.timePickerIncrement) {
                    var b = m
                    10 > b && (b = "0" + b), r += m == e.minute() ? '<option value="' + m + '" selected="selected">' + b + "</option>" : y > m || m > k ? '<option value="' + m + '" disabled="disabled" class="disabled">' + b + "</option>" : '<option value="' + m + '">' + b + "</option>"
                } if (r += "</select> ", this.timePickerSeconds) {
                    for (r += ': <select class="secondselect">', m = 0; 60 > m; m += this.timePickerIncrement) {
                        var b = m
                        10 > b && (b = "0" + b), r += m == e.second() ? '<option value="' + m + '" selected="selected">' + b + "</option>" : '<option value="' + m + '">' + b + "</option>"
                    } r += "</select>"
