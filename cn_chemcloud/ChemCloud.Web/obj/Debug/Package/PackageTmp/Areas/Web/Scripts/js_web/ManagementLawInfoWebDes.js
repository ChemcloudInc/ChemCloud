    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            if (json != null) {
                ...
                $("#spanMeetingTime").html(json.Model.CreateTime);
                $("#spanMeetingPlace").html(json.Model.Author);
                $("#divMeetingContent").html(json.Model.LawsInfo);
                ...
                if (json.PreNextRow.Msg.IsSuccess) {
                    ...
                    if (json.PreNextRow.List[0].Msg.IsSuccess) {
                        ...
                        $("#a_PreInfo").attr("href", "/Search/ManagementWebDes?id=" + json.PreNextRow.List[0].Model.Id);
                    }
                    else {
                    ...
                    if (json.PreNextRow.List[1].Msg.IsSuccess) {
                        ...
                        $("#a_NextInfo").attr("href", "/Search/ManagementWebDes?id=" + json.PreNextRow.List[1].Model.Id);
                    }
                    else {
