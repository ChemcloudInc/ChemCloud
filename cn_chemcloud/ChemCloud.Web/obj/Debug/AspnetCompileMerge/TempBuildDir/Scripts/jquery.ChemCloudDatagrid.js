    ...
    function initialPager(target) {
        ...
        if (opts.pagination) {
            ...
            if (opts.hasCheckbox && !opts.singleSelect) {
                htmlArray.push("<label style=\"margin-left: -7px;\"><input name=\"\" class=\"check-all\" type=\"checkbox\"/>全选</label>");

            }
            htmlArray.push(opts.operationButtonsInnerHTML);
            htmlArray.push("</div>");
            htmlArray.push("<div class=\"pager\">");
            htmlArray.push("<span class=\"active-page\">" + currentPage + "/" + pageCount + " 页，共" + total + "条记录 </span>");
