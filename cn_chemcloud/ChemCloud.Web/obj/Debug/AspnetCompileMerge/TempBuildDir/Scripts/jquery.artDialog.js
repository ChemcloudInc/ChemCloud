...
(function (e, t, n) {
    ...
    v.fn = v.prototype = {
        ...
        position: function (e, t) {
            ...
            t = r._toNumber(t, m - y),
            typeof t == "number" ? ((/SellerAdmin/.test(window.location.pathname) || /Admin/.test(window.location.pathname)) ? (t = u ? t += c : t + d, b.top = 100 + "px") : (t = u ? t += c : t + d, b.top = Math.max(t, d) + "px")) : typeof t == "string" && (b.top = t);
    ...
    if (s) {
        ...
        m.rel = "stylesheet",
        m.href = o + "/../css/" + s + ".css?" + v.fn.version,
