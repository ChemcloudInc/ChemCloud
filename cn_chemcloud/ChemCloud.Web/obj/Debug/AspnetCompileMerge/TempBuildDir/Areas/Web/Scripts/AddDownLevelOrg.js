                ...
                success: function (result) {
                    if (result.success) {
                        $.ajax({
                            type: "post",
                            url: './AddOrganization',
                            data: { username: username, roleId: roleId, parentroleId: parentroleId, parentId: parentId },
                            dataType: "json",
                            async: false,
                            success: function (result) {
                                if (result.success) {
...
function checkCheckCodeIsValid() {
    ...
    if (checkCode && $('#cellPhone').length == 0) {
        $.ajax({
            type: "post",
            url: "/Organization/CheckCheckCode",
