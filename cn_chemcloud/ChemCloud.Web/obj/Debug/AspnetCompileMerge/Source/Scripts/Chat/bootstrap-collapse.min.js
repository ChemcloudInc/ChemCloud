+function (t) {
    ...
    function e(e) {
        ...
        return this.each(function () {
            ...
            !i && n.toggle && "show" == e && (n.toggle = !1), i || a.data("bs.collapse", i = new s(this, n)), "string" == typeof e && i[e]()
        })
    } var s = function (e, a) { this.$element = t(e), this.options = t.extend({}, s.DEFAULTS, a), this.$trigger = t(this.options.trigger).filter('[href="#' + e.id + '"], [data-target="#' + e.id + '"]'), this.transitioning = null, this.options.parent ? this.$parent = this.getParent() : this.addAriaAndCollapsedClass(this.$element, this.$trigger), this.options.toggle && this.toggle() }
        ...
        if (!this.transitioning && !this.$element.hasClass("in")) {
            ...
            if (!(i && i.length && (e = i.data("bs.collapse"), e && e.transitioning))) {
                ...
                if (this.$element.trigger(n), !n.isDefaultPrevented()) {
                    ...
                    var o = function () { this.$element.removeClass("collapsing").addClass("collapse in")[l](""), this.transitioning = 0, this.$element.trigger("shown.bs.collapse") }
    ...
    var i = t.fn.collapse
    t.fn.collapse = a, t.fn.collapse.Constructor = s, t.fn.collapse.noConflict = function () { return t.fn.collapse = i, this }, t(document).on("click.bs.collapse.data-api", '[data-toggle="collapse"]', function (s) {
        var i = t(this)
        i.attr("data-target") || s.preventDefault()
        var n = e(i), l = n.data("bs.collapse"), o = l ? "toggle" : t.extend({}, i.data(), { trigger: this })
        a.call(n, o)
    })
}(jQuery)