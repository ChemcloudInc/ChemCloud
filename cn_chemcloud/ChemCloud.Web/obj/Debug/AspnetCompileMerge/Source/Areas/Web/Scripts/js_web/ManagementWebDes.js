    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            if (json != null) {
                ...
                $("#spanMeetingTime").html(json.Model.MeetingTime);
                $('#spanContinueTime').html(json.Model.ContinueTime);
                $("#spanMeetingPlace").html(json.Model.MeetingPlace);
                $("#divMeetingContent").html(json.Model.MeetingContent);
                ...
                if (json.PreNextRow.Msg.IsSuccess) {
                    ...
                    if (json.PreNextRow.List[0].Msg.IsSuccess) {
                        ...
                        $("#a_PreInfo").attr("href", "/MeetingInfo/ManagementWebDes?id=" + json.PreNextRow.List[0].Model.Id);
                    }
                    else {
                    ...
                    if (json.PreNextRow.List[1].Msg.IsSuccess) {
                        ...
                        $("#a_NextInfo").attr("href", "/MeetingInfo/ManagementWebDes?id=" + json.PreNextRow.List[1].Model.Id);
                    }
                    else {
...
function openMeetionInfo(id) {
    window.location.href = "/MeetingInfo/ManagementWebDes?id=" + id;
}