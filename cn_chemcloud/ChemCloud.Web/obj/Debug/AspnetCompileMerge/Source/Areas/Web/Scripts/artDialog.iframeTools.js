...
; (function ($, window, artDialog, undefined) {
    ...
    artDialog.alert = function (content, callback) {
        ...
        }).content('<div class="tips-custom" style="padding:20px"><i class="icon warning-icon"></i>' + content + '</div>');
    };
    ...
    artDialog.errorTips = function (content, callback, time) {
        ...
        .content('<div class="tips-custom" style="padding:20px"><i class="icon error-icon"></i>' + content + '</div>')
        .time(time || 1.5);
    };
    ...
    artDialog.succeedTips = function (content, callback, time) {
        ...
        .content('<div class="tips-custom" style="padding:20px"><i class="icon succeed-icon"></i>' + content + '</div>')
        .time(time || 1.5);
    };
