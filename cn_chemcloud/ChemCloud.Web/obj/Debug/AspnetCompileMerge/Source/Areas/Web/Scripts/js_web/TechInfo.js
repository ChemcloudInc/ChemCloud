...
$(function () {
    ...
    var startDate1 = addDate(startDate, -7);
    dateTime_SetDefaultsValue("#startDate", "yyyy-mm-dd", startDate1, "zh-CN", "", endDate, startDate1);
    dateTime_SetDefaultsValue("#endDate", "yyyy-mm-dd", endDate, "zh-CN", "", endDate, endDate);
        ...
        success: function (data) {
            ...
            if (!json.Msg.IsSuccess) {
                ...
                for (var i = 0; i < json.List.length; i++) {
                    trList += ("<li><table>"
                            + "<tr><td><a itemId='" + json.List[i].Id + "' onclick='span_ModifyFun(this)'>" + json.List[i].JobTitle + "</a></td><td><label class='label_MemberName'>" + json.List[i].UserId + "</label></td></tr>"
                            + "<tr class='tr_time'><td colspan='2'><label class='label_title'>截止日期：</label><label class='label_EndDate'>" + json.List[i].EndDate + "</label></td></tr>"
                            + "<tr><td colspan='2'>" + json.List[i].JobContent.substring(0, 150) + "</td></tr>"
                            + "</table></li>");
                }
                tbody.html(trList);
            }
